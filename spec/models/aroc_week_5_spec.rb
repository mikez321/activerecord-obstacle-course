...
describe 'ActiveRecord Ostacle Course, Week 5' do
...
# ----------------------
  ...
  it '26. returns the names of items that are associated with one or more orders' do
    ...
    ordered_items_names = Item.joins(:order_items).group('order_items.item_id').pluck(:name)
    # Solution goes here
  ...
  it '27. returns a table of information for all users orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    custom_results = User.joins(:orders).group('orders.user_id').reverse
    # ---------------------------------------------------------------
