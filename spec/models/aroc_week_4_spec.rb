...
# ----------------------
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.joins(:order_items).where(order_items: { item_id: 2})
    #  Solution goes here
    # -----------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    orders = Order.where(user_id: "#{@user_2.id}")
                  .joins(:order_items)
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    ordered_items = Item.joins(:order_items).group('order_items.item_id')
    # Solution goes here
    # ---------------------------------------------------------------
